...
def _package_aoti_files(
    ...
    if len(all_weights) > 0:
        ...
        from torch._inductor.codecache import _to_bytes, _compile_consts
        ...
        specified_sub_dir = os.path.join(WEIGHTS_DIR, "deduped_weights.o")
        ...
        # archive_writer.write_bytes(
        #     os.path.join(WEIGHTS_DIR, "serialized_weights.bin"), serialized_weights
        # )
